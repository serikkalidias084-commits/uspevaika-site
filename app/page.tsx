...
export default function App() {
  // 📱 ИЗМЕНИТЕ НОМЕР ТЕЛЕФОНА ЗДЕСЬ (он обновится по всему сайту):
  const PHONE_NUMBER = '77751316128'        // Только цифры для WhatsApp (например: 77751316128)
  const PHONE_DISPLAY = '+7 (775) 131-61-28' // Красивый формат для чтения пользователями
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-indigo-500 selection:text-white overflow-hidden relative">
      ...
      <nav className="relative z-10 max-w-7xl mx-auto px-6 h-24 flex items-center justify-between border-b border-zinc-800/50 backdrop-blur-md">
        ...
        <a 
          href={`https://wa.me/${PHONE_NUMBER}?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!%20%D0%98%D0%BD%D1%82%D0%B5%D1%81%D0%B5%D1%81%D1%83%D0%B5%D1%82%20%D0%BE%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5%20%D0%B2%20%D1%86%D0%B5%D0%BD%D1%82%D1%80%D0%B5%20%C2%ABBilim%20Oner%C2%BB.`} 
          target="_blank" 
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-6 py-12 border-t border-zinc-800/50 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500">
        ...
        <div className="flex items-center gap-6">
          ...
          <a href={`https://wa.me/${PHONE_NUMBER}?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!%20%D0%98%D0%BD%D1%82%D0%B5%D1%81%D0%B5%D1%81%D1%83%D0%B5%D1%82%20%D0%BE%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5%20%D0%B2%20%D1%86%D0%B5%D0%BD%D1%82%D1%80%D0%B5%20%C2%ABBilim%20Oner%C2%BB.`} target="_blank" rel="noopener noreferrer" className="hover:text-zinc-300 transition-colors flex items-center gap-1.5">
            <MessageCircle className="w-4 h-4 text-emerald-400" />
