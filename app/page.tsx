...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF3F5] text-slate-900 selection:bg-rose-800 selection:text-white relative overflow-hidden">
      {/* МЯГКИЙ РОЗОВЫЙ ФОНОВЫЙ ГРАДИЕНТ */}
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute top-0 left-1/3 -translate-x-1/2 w-[600px] h-[600px] bg-rose-300/20 rounded-full blur-[160px]" />
        <div className="absolute top-1/4 right-1/4 w-[450px] h-[450px] bg-pink-300/20 rounded-full blur-[150px]" />
      </div>

      {/* ШАПКА / НАВИГАЦИЯ */}
      <header className="sticky top-0 z-50 backdrop-blur-md bg-[#FAF3F5]/90 border-b border-rose-200/60 shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <a href="#" className="flex items-center gap-3 group">
            <AtelierLogoSVG className="w-11 h-11 rounded-xl shadow-md shadow-rose-900/10" />
            <div>
              <span className="block font-bold text-lg tracking-tight text-slate-900 group-hover:text-rose-800 transition-colors">
                {COMPANY_NAME}
              </span>
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-700">
            <a href="#advantages" className="hover:text-rose-800 transition-colors">
              Преимущества
            </a>
            <a href="#services" className="hover:text-rose-800 transition-colors">
              Услуги и цены
            </a>
            <a href="#locations" className="hover:text-rose-800 transition-colors">
              Адреса
            </a>
            <a href="#faq" className="hover:text-rose-800 transition-colors">
              FAQ
            </a>
            <a href="#contact" className="hover:text-rose-800 transition-colors">
              Записаться
            </a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-4.5 py-2.5 rounded-xl bg-rose-800 hover:bg-rose-700 text-white font-medium text-sm shadow-md shadow-rose-900/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-200/60 border border-rose-300 text-xs font-semibold text-rose-900">
                <span className="flex h-2 w-2 rounded-full bg-rose-700 animate-pulse" />
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 px-7 py-4 rounded-xl bg-rose-800 hover:bg-rose-700 text-white font-semibold shadow-lg shadow-rose-900/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
                >
                ...
                <a
                  href="#services"
                  className="inline-flex items-center gap-2 px-6 py-4 rounded-xl bg-white/80 hover:bg-white border border-rose-200 text-slate-800 font-semibold transition-all shadow-xs"
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-6 border-t border-rose-200/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-600">Стаж мастера</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-600">Кез келген киім</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 col-span-2 sm:col-span-1">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-600">В центре Атырау</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-3xl bg-white/90 border border-rose-200 p-6 sm:p-8 shadow-xl backdrop-blur-xs">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-emerald-700 font-medium">● Открыто / Прием заказов</p>
                    </div>
                  </div>
                  <a
                    href={INSTAGRAM_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-rose-100 hover:bg-rose-200 text-xs font-semibold text-rose-800 border border-rose-200 transition-colors"
                  >
                ...
                <div className="space-y-4 mb-6">
                  <div className="p-4 rounded-2xl bg-white/70 border border-rose-200/70 flex items-start gap-3">
                  ...
                  <div className="p-4 rounded-2xl bg-white/70 border border-rose-200/70 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <Clock className="w-5 h-5 text-rose-800 shrink-0" />
                      <div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-rose-800 hover:bg-rose-700 text-sm font-semibold text-white transition-colors"
                  >
                    <MessageCircle className="w-4 h-4" />
                    <span>WhatsApp</span>
                  </a>
      ...
      {/* БЛОК ПРЕИМУЩЕСТВ */}
      <section id="advantages" className="relative z-10 py-20 border-t border-rose-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs font-semibold tracking-wider uppercase text-rose-800 bg-rose-200/60 px-3 py-1 rounded-full border border-rose-300">
              Почему выбирают нас
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="rounded-2xl bg-white/90 border border-rose-200 p-6 hover:border-rose-400 transition-all group shadow-xs">
              <div className="w-12 h-12 rounded-xl bg-rose-100 flex items-center justify-center text-rose-800 mb-5 group-hover:scale-110 transition-transform">
      ...
      <section id="services" className="relative z-10 py-20 border-t border-rose-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {SERVICES.map((service) => (
              <div
                key={service.id}
                className="rounded-3xl bg-white/90 border border-rose-200 p-7 flex flex-col justify-between hover:border-rose-400 transition-all shadow-sm"
              >
                <div>
                  ...
                  <div className="text-xs font-semibold text-rose-800 mb-4">{service.subtitle}</div>
                  ...
                  <ul className="space-y-2.5 mb-8">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center gap-2.5 text-sm text-slate-700">
                        <CheckCircle2 className="w-4 h-4 text-rose-800 shrink-0" />
                        <span>{feature}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-5 rounded-xl bg-rose-800 hover:bg-rose-700 text-white font-semibold text-sm shadow-md shadow-rose-900/20 transition-all hover:scale-[1.01]"
                >
                  <MessageCircle className="w-4 h-4" />
      ...
      <section id="locations" className="relative z-10 py-20 border-t border-rose-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs font-semibold tracking-wider uppercase text-rose-800 bg-rose-200/60 px-3 py-1 rounded-full border border-rose-300">
              Где нас найти
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
            {/* Карточка 1 */}
            <div className="rounded-3xl bg-white/90 border border-rose-200 p-7 flex flex-col justify-between shadow-xs">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="px-3 py-1 rounded-lg bg-rose-100 text-rose-800 text-xs font-semibold border border-rose-200">
                    Филиал №1
                  </span>
                  <span className="text-xs text-slate-500 flex items-center gap-1">
                    <Clock className="w-3.5 h-3.5 text-rose-800" /> 9:00 – 16:00 (Обед 13:00–14:00)
                  </span>
                </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white hover:bg-rose-50 text-sm font-medium text-slate-800 border border-rose-200 transition-colors shadow-xs"
                >
            ...
            <div className="rounded-3xl bg-white/90 border border-rose-200 p-7 flex flex-col justify-between shadow-xs">
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs text-slate-500 flex items-center gap-1">
                    <Clock className="w-3.5 h-3.5 text-rose-800" /> Ежедневно
                  </span>
                </div>
      ...
      {/* БЛОК FAQ (АККОРДЕОН) */}
      <section id="faq" className="relative z-10 py-20 border-t border-rose-200/50">
          ...
          <div className="space-y-4">
            {FAQ_DATA.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="rounded-2xl bg-white/90 border border-rose-200 overflow-hidden transition-all shadow-xs"
                >
                  <button
                    onClick={() => toggleFaq(idx)}
                    className="w-full p-6 text-left flex items-center justify-between gap-4 font-semibold text-slate-900 hover:text-rose-800 transition-colors"
                  >
                    <span>{item.question}</span>
                    <ChevronDown
                      className={`w-5 h-5 text-rose-800 transition-transform duration-200 ${
                        isOpen ? 'rotate-180' : ''
                      }`}
                    />
                  </button>
                  {isOpen && (
                    <div className="px-6 pb-6 text-sm text-slate-600 leading-relaxed border-t border-rose-100 pt-4">
                      {item.answer}
                    </div>
                  )}
                </div>
      ...
      <section id="contact" className="relative z-10 py-20 border-t border-rose-200/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-rose-900 text-white p-8 sm:p-12 shadow-2xl">
            <div className="text-center max-w-xl mx-auto mb-10">
              <span className="text-xs font-semibold tracking-wider uppercase text-rose-100 bg-white/20 px-3 py-1 rounded-full border border-white/30">
                Записаться онлайн
              </span>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  <label className="block text-xs font-medium text-rose-100 mb-2">Ваше имя *</label>
                  <div className="relative">
                    <User className="w-4 h-4 text-rose-300 absolute left-4 top-1/2 -translate-y-1/2" />
                    <input
                      type="text"
                      required
                      ...
                      className="w-full bg-white/10 border border-white/20 rounded-xl pl-11 pr-4 py-3.5 text-sm text-white placeholder:text-rose-200 focus:outline-none focus:bg-white/20 transition-colors"
                    />
                  </div>
                </div>

                <div>
                  <label className="block text-xs font-medium text-rose-100 mb-2">Номер телефона *</label>
                  <div className="relative">
                    <Phone className="w-4 h-4 text-rose-300 absolute left-4 top-1/2 -translate-y-1/2" />
                    <input
                      type="tel"
                      required
              ...
              <div>
                <label className="block text-xs font-medium text-rose-100 mb-2">Выберите услугу *</label>
                <select
                  value={formService}
                  onChange={(e) => setFormService(e.target.value)}
                  className="w-full bg-rose-950/80 border border-white/20 rounded-xl px-4 py-3.5 text-sm text-white focus:outline-none focus:bg-rose-950 transition-colors"
                >
              ...
              <div>
                <label className="block text-xs font-medium text-rose-100 mb-2">Комментарий или пожелания</label>
                <textarea
                  rows={3}
                  placeholder="Опишите желаемую модель, дату торжества или вопрос..."
                  value={formComment}
                  onChange={(e) => setFormComment(e.target.value)}
                  className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3.5 text-sm text-white placeholder:text-rose-200 focus:outline-none focus:bg-white/20 transition-colors resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full py-4 px-6 rounded-xl bg-white hover:bg-stone-100 text-rose-900 font-bold text-sm shadow-lg transition-all hover:scale-[1.01] flex items-center justify-center gap-2"
              >
      ...
      {/* ФУТЕР */}
      <footer className="relative z-10 border-t border-rose-900 bg-rose-950 text-rose-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="block text-xs text-rose-300/70">Ателье в Атырау</span>
              </div>
            </div>

            <div className="flex flex-wrap items-center gap-6 text-sm text-rose-200/80">
              ...
              <a href={GIS_LINK} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                2GIS Атырау
              </a>
            </div>
